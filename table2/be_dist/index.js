...
/* send email after submit reservation */
app.post("/sendemail", (req, res) => {
    var transporter = nodemailer.createTransport({
        ...
        auth: {
            user: "sutkiene.asta@gmail.com",
            pass: "xxxxxx"
        }
    });

    var mailOptions = {
        from: "sutkiene.asta@gmail.com",
        to: "sutkiene.asta@gmail.com",
        subject: "Nodejs Mail",
        text: "this is the email's body text..."
    };

    transporter.sendMail(mailOptions, function (error, info) {
        if (error) console.log(error);else console.log("Message sent successfully: " + info.response);
    });
});
/* end of send email after submit reservation */
